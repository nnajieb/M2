 ...
 */
 public class AntLabMain {
    ...
    public void printOutMessage() {
        String toPrint =
                ant11.getMessage() + ant12.getMessage() +
                ant21.getMessage() + ant22.getMessage() +
                ant31.getMessage();

        Person1 p1 = new Person1("Nyaire Najieb");
        toPrint += p1.toString("nnajieb3");

        Person2 p2 = new Person2("Edward");
        toPrint += p2.toString("elee399");

        Person3 p3 = new Person3("Jonathan");
        toPrint += p3.toString("jbuchanan41");

        Person4 p4 = new Person4("Ida");
        toPrint += p4.toString("iwang43");

        Person5 p5 = new Person5("Jessica Paley");
        toPrint += p5.toString("jpaley3");
